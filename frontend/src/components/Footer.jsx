...
const Footer = () => {
  return (
    <div >
        <footer className="mt-auto w-full max-w-[95rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-gray-800" style={{backgroundImage:`url(https://images.rawpixel.com/image_800/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvbHIvcm00OTQtYmctMDE4LXguanBn.jpg)` ,backgroundRepeat:`no-repeat`,backgroundSize:`cover`}}>
  {/* Grid */}
  <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
    <div>
      <a
        className="flex-none text-xl font-semibold text-black focus:outline-none dark:text-black"
        href="#"
        aria-label="Brand"
      >
       PAWS & CLAWS
