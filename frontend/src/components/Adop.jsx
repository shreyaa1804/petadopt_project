    ...
    <div className='bg-gray-100' >
      ...
      <div className='grid grid-cols-12 max-w-[80%] mx-10'>
        ...
        <div className='col-span-12 md:col-span-4 my-32'>
          ...
          <p className='text-gray-500 my-4'>Adopt a dog or cat who's right for you. Simply ,Click on Adopt Me.</p>
          <br />
          <h1 className='font-bold text-xl text-gray-600'>CONNECT</h1>
          <p className='text-gray-500 my-4'>Once you find a pet, Call on the " contact number" to get  info for their pet parent or rescue. Contact them to learn more about how to meet and adopt the pet.</p>
         <br />
