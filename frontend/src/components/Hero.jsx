...
const Hero = () => {
    return (
        <div>
            {/* Slider */}
            <div data-hs-carousel='{"loadingClasses": "opacity-100"}' className="px-4 lg:px-6 lg:px-8 py-10">
                ...
                <div  className="relative">
                    ...
                    <div className="hs-carousel relative overflow-hidden w-full h-[30rem] md:h-[calc(100vh-106px)]  bg-gray-100 rounded-2xl dark:bg-neutral-800">
                        ...
                        <div className="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-80">
                            {/* Item */}
